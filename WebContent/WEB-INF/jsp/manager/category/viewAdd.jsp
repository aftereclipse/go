...
<div class="row-fluid ">
	<h5 class="offset1"><i class="icon-plus"></i> 创建新标签</h5>
</div>
<div class="row-fluid ">
	<div class="span7 offset1">		
	<form action = "manager/category/add" method = "post">
		<div class="row-fluid">
			<label class="span2" for="name">标签名称</label>
			<input type = "text" class="span4" name = "name" id="name" value="${requestScope.name }" autocomplete = "off" />
